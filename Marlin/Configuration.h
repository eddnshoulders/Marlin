 ...
 */
#define TEMP_SENSOR_0 13//#define TEMP_SENSOR_1 0
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 1044 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 200 }
 ...
 *
 */
//#define Z_MIN_PROBE_PIN P1_24 // Pin P1_24 SKR Z_MAX_PIN
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0.49, -27.43, -1.65 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (18.9)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (39.0)    // Y point for Z homing when homing all axes (G28).
#endif
